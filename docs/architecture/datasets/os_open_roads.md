...
- Normalised fields:
  ...
  - optional `geom_bng` (decoded from GeoPackage geometry blob, SRID 27700)
...
- Pass 5 prioritises postal-plausible names, applies optional PPD tie-break scoring, and keeps radius at 150m.
